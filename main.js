...
// GET REQUEST
function getTodos() {
    //Method 1 for GET request using AXIOS
    // axios({
    //     method: 'get',
    ...
    //Method 2 for GET request using AXIOS
...
// POST REQUEST
function addTodo() {
    // Method 1 for POST request using AXIOS
    // axios({
    //     method: 'post',
    //     url: 'https://jsonplaceholder.typicode.com/todos',
    //     data: {
    ...
    //Method 2 for POST request using AXIOS
...
// PUT/PATCH REQUEST
function updateTodo() {
    // axios.put('https://jsonplaceholder.typicode.com/todos/1', { title: 'TODO UPDATED', completed: true })
    //     .then(res => showOutput(res))
    //     .catch(err => console.log(err))
...
function transformResponse() {
    ...
    axios(options).then(res => showOutput(res)).catch(err => console.log(err, "Hello"));
}
